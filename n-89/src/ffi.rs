...
pub const DeviceType_DEVICE_TYPE_83P: DeviceType = 115;
pub const DeviceType_DEVICE_TYPE_73: DeviceType = 116;
pub const DeviceType_DEVICE_TYPE_89: DeviceType = 152;
pub const DeviceType_DEVICE_TYPE_92P: DeviceType = 136;
#[doc = " DeviceType:"]
#[doc = ""]
#[doc = " An enumeration which contains some device IDs for FLASH apps:"]
pub type DeviceType = u32;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct IMG_INFO32 {
	pub signature: [cty::c_char; 16usize],
	pub revision: i32,
	pub header_size: i32,
	pub calc_type: u8,
	pub version: [u8; 5usize],
	pub flash: u8,
	pub has_boot: u8,
	pub size: i32,
	pub hw_type: u8,
	pub rom_base: u8,
	pub fill: [cty::c_char; 22usize],
...
extern "C" {
	pub static mut img_loaded: cty::c_int;
}
extern "C" {
	pub static mut img_changed: cty::c_int;
}
extern "C" {
